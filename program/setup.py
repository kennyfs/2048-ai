    ...
    def getInt(self, key, default=None):
        if key in self.keyValues:
            try:
                ...
                raise ValueError(
                    f"Invalid value for int, key = {key}, value = {self.keyValues[key]}"
                )
        if default is not None:
    ...
    def getFloat(self, key, default=None):
        if key in self.keyValues:
            try:
                ...
                raise ValueError(
                    f"Invalid value for float, key = {key}, value = {self.keyValues[key]}"
                )
        if default is not None:
    ...
    def getPath(self, key, default=None):
        ...
        if default is not None:
            if isinstance(default, str):
                ...
                return default
            raise ValueError(
                f"Invalid default value for path, key = {key}, default = {default}"
            )
